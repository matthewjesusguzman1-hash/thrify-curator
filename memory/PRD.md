...
- **Changed**: Replaced with soft warm linen palette (#f6f4f0 headers, #f3f0ec→#e7e3de gradient)
- **Refined**: Further softened after user feedback — lighter backgrounds, reduced contrast, gentler shadows

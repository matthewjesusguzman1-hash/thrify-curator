...
const STEPS = [
  {
    ...
    items: [
      ...
      { id: "1.3", label: "HM Registration when required", ref: "107.601", tip: "Required for any person who transports in commerce: a highway route-controlled quantity of radioactive material, more than 55 lbs of Division 1.1/1.2/1.3 material, more than 1 liter per package of material extremely toxic by inhalation, a bulk shipment of HM with a capacity of 3,500 gal or more. Registration is through PHMSA and must be renewed annually." },
  ...
  },
  {
    ...
    icon: ClipboardCheck,
    tip: "The shipping paper is the most critical document for identifying hazardous materials. Always verify using the Hazardous Materials Table (172.101) — it has 10 columns. The basic description must appear in a specific sequence: Proper Shipping Name, Hazard Class/Division, ID Number, Packing Group.",
    items: [
      ...
      { id: "2.9", label: "Basic description in proper sequence", ref: "172.202(b)", tip: "Required sequence: Proper Shipping Name, Hazard Class/Division, UN/NA ID Number, Packing Group. Example: 'Gasoline, 3, UN1203, PG II'. Additional info (technical name, RQ, etc.) may be added before, after, or within but cannot break the required sequence." },
      ...
      { id: "2.17", label: "Empty Packages", ref: "172.203(e)", tip: "The description may include the word 'EMPTY' before or after the basic description if the packaging was previously used for HM and has not been cleaned/purged. Last contained materials must still be identified." },
      { id: "2.18", label: "Cargo tanks with Anhydrous Ammonia or LPG", ref: "172.203(f)", tip: "For Anhydrous Ammonia (UN1005) or LPG (UN1075) in cargo tanks, additional description requirements may apply including percentage of product, capacity of the tank, and whether it's a nurse tank operation." },
      ...
      { id: "2.23", label: "Organic peroxide / self-reactive material", ref: "172.203(o)", tip: "The description must include the type letter (A through G) for the organic peroxide or self-reactive material, the control and emergency temperatures if required, and the word 'SAMPLE' if applicable." },
      ...
      { id: "2.25", label: "Check emergency response telephone number", ref: "172.604(a)(3)", tip: "Must be monitored at all times the material is in transportation. Answering machines or voicemail are NOT acceptable. CHEMTREC (1-800-424-9300) is commonly used. The number must be for a person with knowledge of the material or immediate access to someone with such knowledge." },
    ],
  },
  {
    step: 3,
  ...
  },
  {
    ...
    items: [
      ...
      { id: "4.1", label: "Table 1 materials require placards in ANY amount", ref: "172.504(e)", tip: "Table 1 (most dangerous): Div 1.1–1.3 (Explosives), Div 2.3 (Poison Gas), Div 4.3 (Dangerous When Wet), Div 6.1 PG I (Poison/Toxic), Class 7 (Radioactive). These ALWAYS require placards regardless of quantity — even a single small package." },
      { id: "4.2", label: "Table 2 materials require placards over 1,001 lbs aggregate", ref: "172.504(e)", tip: "Table 2: Div 1.4–1.6, Div 2.1 (Flammable Gas), Div 2.2 (Non-flammable Gas), Class 3, Div 4.1–4.2, Class 5, Div 6.1 PG II/III, Class 8, Class 9, ORM-D. 'Aggregate' = total gross weight of ALL Table 2 materials on the vehicle combined." },
      ...
      { id: "4.6", label: "Combustible liquids in non-bulk packages", ref: "172.500(b)", tip: "Combustible liquids (flash point 100–200°F) in non-bulk packages are generally exempt from placarding. However, if in bulk packaging (>119 gal), the COMBUSTIBLE placard is required." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "5.1", label: "If poisonous — verify package is marked as required", ref: "172.313", tip: "Packages of Division 6.1 PG I or II (other than Class 7 or Class 8) in non-bulk must be marked 'PG I - TOXIC' or 'PG II - TOXIC'. Look for the word 'INHALATION HAZARD' on packages of PIH materials." },

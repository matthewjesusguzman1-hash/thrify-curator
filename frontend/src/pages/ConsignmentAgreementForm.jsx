      ...
      <div className="min-h-screen bg-gradient-to-br from-[#1A1A2E] via-[#16213E] to-[#0F3460] py-8 px-4" data-testid="consignment-choice-page">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="relative mt-8 mb-6">
            <Link to="/" onClick={() => lightTap()} className="absolute left-0 top-0 inline-flex items-center gap-2 text-white/70 hover:text-[#8B5CF6] transition-colors" data-testid="back-link-top">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-gray-200 rounded-xl overflow-hidden">
                    <button
                      ...
                      data-testid="toggle-account-details"
                    >
                      <div className="flex items-center gap-3">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    ...
                    {showAccountDetails && addItemsAgreement && (
                        ...
                        <div>
                          ...
                          <div className="bg-white rounded-lg border border-gray-100 divide-y divide-gray-50">
                            <div className="flex justify-between items-center p-3">
                              ...
                              <span className="text-sm font-medium text-[#1A1A2E]">{addItemsAgreement.full_name}</span>
                            </div>
                            <div className="flex justify-between items-center p-3">
                              <span className="text-sm text-gray-500">Email</span>
                              <span className="text-sm font-medium text-[#1A1A2E]">{addItemsAgreement.email}</span>
                            </div>
                            <div className="flex justify-between items-center p-3">
                              <span className="text-sm text-gray-500">Phone</span>
                              <span className="text-sm font-medium text-[#1A1A2E]">{addItemsAgreement.phone || 'Not provided'}</span>
                            </div>
                            <div className="flex justify-between items-start p-3">
                              <span className="text-sm text-gray-500">Address</span>
                              <span className="text-sm font-medium text-[#1A1A2E] text-right max-w-[60%]">{addItemsAgreement.address || 'Not provided'}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="bg-white rounded-lg border border-gray-100 divide-y divide-gray-50">
                            <div className="flex justify-between items-center p-3">
                              ...
                              <span className="text-sm font-semibold text-emerald-600">{addItemsAgreement.agreed_percentage || '50/50'}</span>
                            </div>
                            <div className="flex justify-between items-center p-3">
                              <span className="text-sm text-gray-500">Payment Method</span>
                              <span className="text-sm font-medium text-[#1A1A2E] capitalize">{addItemsAgreement.payment_method || 'Not set'}</span>
                            </div>
                            {addItemsAgreement.payment_details && (
                              <div className="flex justify-between items-center p-3">
                                <span className="text-sm text-gray-500">Payment Details</span>
                                <span className="text-sm font-medium text-[#1A1A2E]">{addItemsAgreement.payment_details}</span>
                              </div>
                            )}
                            <div className="flex justify-between items-center p-3">
                              <span className="text-sm text-gray-500">Agreement Date</span>
                              <span className="text-sm font-medium text-[#1A1A2E]">
                                {addItemsAgreement.submitted_at ? new Date(addItemsAgreement.submitted_at).toLocaleDateString('en-US', {
                                  month: 'short',
                                  day: 'numeric',
                                  year: 'numeric'
                                }) : 'N/A'}

  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          {/* Static gradient background elements - optimized for performance */}
          <div className="absolute inset-0 overflow-hidden">
            ...
            <motion.div
              ...
              className="absolute top-1/4 left-1/4 w-[300px] h-[300px] bg-[#00D4FF] rounded-full blur-[80px]"
            />
            
            {/* Pink/magenta glow - static position */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 0.4 }}
              transition={{ duration: 1.5, ease: "easeOut", delay: 0.2 }}
              className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-[#FF1493] rounded-full blur-[80px]"
            />
            
            {/* Purple glow in center - static */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 0.35 }}
              transition={{ duration: 1.5, ease: "easeOut", delay: 0.4 }}
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] bg-[#8B5CF6] rounded-full blur-[60px]"
            />
          </div>

    ...
    <div className="bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-white">Taxes & Deductions</h3>
            <p className="text-sm text-white/60">
              {formatCurrency(expenses.total + mileageDeduction)} in write-offs
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          {/* Year Selector - stop propagation so it doesn't toggle */}
          <select
            value={selectedYear}
            onChange={(e) => {
              e.stopPropagation();
            ...
            className="px-2 py-1 bg-gray-800 border border-white/30 rounded-lg text-white text-sm focus:outline-none"
            style={{ backgroundColor: '#1f2937', color: 'white' }}
          >
            <option value={2026} style={{ backgroundColor: '#1f2937', color: 'white' }}>2026</option>
            <option value={2025} style={{ backgroundColor: '#1f2937', color: 'white' }}>2025</option>
            <option value={2024} style={{ backgroundColor: '#1f2937', color: 'white' }}>2024</option>
            <option value={2023} style={{ backgroundColor: '#1f2937', color: 'white' }}>2023</option>
          </select>
          {isExpanded ? (
            ...
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="bg-white rounded-lg border border-gray-200 p-3">
                  ...
                  <div className="text-xs text-gray-500">{expenses.count || 0} expenses</div>
                </div>

                <div className="bg-white rounded-lg border border-gray-200 p-3">
                  <div className="text-xs text-gray-500 mb-1">Mileage Deduction</div>
                  <div className="text-xl font-bold text-gray-900">
                    {formatCurrency(mileageDeduction)}
                  </div>
                  <div className="text-xs text-gray-500">
                    {mileageData?.total_miles?.toLocaleString() || 0} mi @ $0.67
                  </div>
                </div>

                <div className="bg-white rounded-lg border border-gray-200 p-3">
                  <div className="text-xs text-gray-500 mb-1">Total Tax Write-offs</div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-3">
                  <div className="text-xs text-gray-500 mb-1">Est. Tax Savings</div>
                  <div className="text-xl font-bold text-green-600">
                    {formatCurrency(estimatedTaxSavings + (mileageDeduction * 0.25))}
                  </div>
                  <div className="text-xs text-gray-500">~25% bracket</div>
                </div>
              </div>

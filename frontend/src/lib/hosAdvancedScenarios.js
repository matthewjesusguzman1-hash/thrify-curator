    ...
    days: [
      ...
      },
      {
        ...
        log: [
          ...
          { status: "OD",  start: "06:00", end: "07:00" },
          { status: "D",   start: "07:00", end: "12:00" },
          { status: "OD",  start: "12:00", end: "12:15" },
          { status: "D",   start: "12:15", end: "15:30" },
          { status: "OFF", start: "15:30", end: "24:00" },
        ],
        shiftStartMin: 6 * 60, shiftEndMin: 15 * 60 + 30,
        onDutyHours: 9.5,
        ...
        explanation: {
          shift: "Shift 06:00 → 15:30 (9.5h wall-clock). Drive 5h+3.25h = 8.25h.",
          violation: "8-hr break VIOLATION. §395.3(a)(3)(ii). The 12:00–12:15 OD segment is only 15 min — under the current rule (post-2020) the 30-min break can be ANY non-driving status (OFF, SB, or OD) but it must be at LEAST 30 min. 15 min is too short. Driver hit 8h cumulative drive at 15:00 with no qualifying break.",
        },
      },
      {
        label: "Day 0", dayName: "Mon (today, in progress)",
        log: [
          { status: "OFF", start: "00:00", end: "06:00" },
          { status: "OD",  start: "06:00", end: "07:00" },
          { status: "D",   start: "07:00", end: "11:00" },
          { status: "OFF", start: "11:00", end: "11:30" },
          { status: "D",   start: "11:30", end: "13:00" },
        ],
        truncated: true,
        truncatedNote: "Driver pulled in for roadside inspection at 13:00. Day 0 is in progress — no log entries past 13:00.",
        shiftStartMin: 6 * 60, shiftEndMin: 13 * 60,
        onDutyHours: 6.5,
        violation11: false, violation14: false, violation8: false,
        explanation: {
          shift: "Shift 06:00 → in progress. So far: 1h OD + 4h D + 30 min OFF + 1.5h D = 6.5h on-duty (5.5h drive). Inspection time = 13:00, shift continues.",
          violation: "Today is clean SO FAR — but cite the past 14-hr violation (Day −4) and 8-hr break violation (Day −1) on the inspection report.",
        },
      },
    ],
    cycleViolation: false,
    cycleNote: "Cumulative on-duty across the 8 days (counting Day 0 only through the inspection moment): 9 + 4.5 + 5 + 14 + 7 + 9.5 + 9.5 + 6.5 = 65h. Under the 70-hr cap.",
    oosRequired: false,
    oosReason: "Driver is presently compliant — current day clean through the inspection moment, cumulative 65h under cap. The Day −4 14-hr violation and Day −1 8-hr break violation are PAST violations the driver is no longer engaged in, so §395.13 does NOT require placing OOS today. Cite both violations on the inspection report and document the overnight shift on Days −6/−5 as a teaching point.",
  },
  {
    id: "E2",
    ...
    days: [
      ...
      },
      {
        ...
        log: [
          ...
          { status: "OD",  start: "05:00", end: "06:00" },
          { status: "D",   start: "06:00", end: "11:00" },
          { status: "OD",  start: "11:00", end: "11:15" },
          { status: "D",   start: "11:15", end: "15:30" },
          { status: "OFF", start: "15:30", end: "24:00" },
        ],
        shiftStartMin: 5 * 60, shiftEndMin: 15 * 60 + 30,
        onDutyHours: 10.5,
        violation11: false, violation14: false, violation8: true,
        explanation: {
          shift: "Shift 05:00 → 15:30 (10.5h wall-clock). Drive 5h+4.25h = 9.25h.",
          violation: "8-hr break VIOLATION. §395.3(a)(3)(ii). The 11:00–11:15 OD segment is only 15 min — under the current rule (post-2020) the 30-min break can be ANY non-driving status (OFF, SB, or OD) but must be at LEAST 30 min. Driver hit 8h cumulative drive at 14:00 with no qualifying break.",
        },
      },
      {
        label: "Day −4", dayName: "Thu",
      ...
      },
      {
        ...
        explanation: {
          ...
          violation: "8-hr break VIOLATION. Driver hit 8 cumulative hours of driving without ANY 30-min non-driving interruption — §395.3(a)(3)(ii). Under the 2020 rule the break can be OFF / SB / OD ≥30 min, but no such break exists between 07:00 and 15:30. Break should have been taken before 15:00 (8h after first drive).",
        },
      },
      {
        label: "Day −1", dayName: "Sun",
      ...
      },
      {
        ...
        log: [
          { status: "D",   start: "00:00", end: "04:30" },
          { status: "OD",  start: "04:30", end: "05:00" },
          { status: "OFF", start: "05:00", end: "09:00" },
        ],
        truncated: true,
        truncatedNote: "Driver shut down at 05:00 after the overnight shift; roadside inspection occurred during the rest period at 09:00. Day 0 is in progress — no log entries past 09:00.",
        shiftStartMin: 0, shiftEndMin: 5 * 60,
        continuesFromPrev: true,
        onDutyHours: 5,
        violation11: false, violation14: false, violation8: false,
        explanation: {
          shift: "Day 0 portion of the overnight shift: continues from 18:00 Day −1 → ends 05:00 Day 0. Bracket Day 0's portion at 00:00 → 05:00 (last OD). Inspection moment = 09:00 (during driver's rest period).",
    ...
    cycleViolation: true,
    cycleNote: "Cumulative on-duty (counting Day 0 only through the inspection moment): 10 + 14 + 10.5 + 12.5 + 7 + 9.5 + 5.5 + 5 = 74h. Past the 70-hr cap by 4h. Cite §395.3(b)(2).",
    oosRequired: true,

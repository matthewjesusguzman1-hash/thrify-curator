...
export const ELD_TOPICS = [
...

  {
    ...
    short: "Records that corroborate the RODS",
    cfr: "49 CFR §395.11",
    color: "#7C2D12",
    summary:
      "Carriers must collect and retain supporting documents that corroborate a driver's RODS — up to 10 per 24-hour period. These cross-check driving time, on-duty time, and location. Missing supporting docs alone are a carrier violation, not a driver violation.",
    sections: [
      {
        heading: "What counts as a supporting document (§395.11(c))",
        body: "Only 5 categories of document are required:",
        bullets: [
          "Bills of lading, itineraries, schedules, and similar documents showing the origin and destination.",
          "Dispatch records, trip records, and similar documents.",
          "Expense receipts.",
          "Electronic mobile communication records reflecting communications between the driver and the carrier.",
          "Payroll records, settlement sheets, or similar documents showing payment to a driver.",
        ],
      },
      {
        heading: "Retention and limits",
        body: "Carriers must retain supporting documents for 6 months. Only the FIRST AND LAST documents for each 24-hour period are required — up to a total of 10 per day. The driver submits documents to the carrier within 13 days of receiving them.",
      },
      {
